...
public class Lab5 extends GLJPanel implements GLEventListener, KeyListener{
    ...
    private void pyramidBase(GL2 gl2) {
        double x, y;
    ...
    private void pyramidWalls(GL2 gl2) {
        double x, y;
        gl2.glBegin(GL.GL_TRIANGLE_FAN);
    ...
    private void spiral(GL2 gl2) {
    	gl2.glColor3f(0, 0, 10);
        gl2.glBegin(GL.GL_LINE_STRIP);
        double x, y;
        var angle = 2 * Math.PI / 36;
        for (float i = 1; i <= sides * 36; i++) {
            x = Math.cos(angle * i);
            y = Math.sin(angle * i);
    ...
    private void hexSpiral(GL2 gl2) {
        gl2.glColor3f(0, 0, 10);
        gl2.glBegin(GL.GL_LINE_STRIP);
        double x, y;
